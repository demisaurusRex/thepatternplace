...
instructions =
  [
    ...
    {
      category: {
        pattern_id: 3, name: "Outer Seams", position: 9
      },
      pattern_id: 3,
      steps:
      [
    ...
    {
      category: {
        pattern_id: 3, name: "Attaching Belt Loops and Waistband", position: 10
      },
      pattern_id: 3,
      steps:
      [
    ...
    {
      category: {
        pattern_id: 3, name: "Hems", position: 11
      },
      pattern_id: 3,
      steps:
      [
    ...
    {
      category: {
        pattern_id: 3, name: "Buttons and finishes", position: 12
      },
      pattern_id: 3,
      steps:
      [
